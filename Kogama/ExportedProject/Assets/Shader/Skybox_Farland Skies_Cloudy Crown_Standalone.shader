Shader "Skybox/Farland Skies/Cloudy Crown_Standalone" {
	Properties {
		...
		[NoScaleOffset] _StarsTwinklingTex ("Stars Twinkling Cubemap", Cube) = "grey" {}
	...
	Fallback "Skybox/Farland Skies/Cloudy Crown_WebGL"
}